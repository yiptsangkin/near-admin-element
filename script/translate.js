    ...
    void async function () {
        ...
        currentLocaleList.forEach(function (citem) {
            if (withBaseFile(citem)) {
                ...
                antdLocale.push(`import ${antdName} from 'element-ui/lib/locale/lang/${localeConfig[defaultName].elLocale}'`)
                antdOpt.push(`['${localeConfig[defaultName].locale}']: ${antdName}`)
                customLocale.push(`import ${customerName} from '@locale/${citem}'`)
                customOpt.push(`['${localeConfig[defaultName].locale}']: {...${customerName}, ...${antdName}}`)
            }
        })
        // read lang.tpl
